...
# SensorValues4ATCRBSD = pickle.load( open('output/nonlinearComplianceMatrixStaticCircularHinge/nonlinearComplianceMatrixSensorValues.pickle',  'rb') ) # loading sensor values
# SensorValues4ATCRBSDImport = pickle.load( open('output/nonlinearComplianceMatrixStaticCircularHinge/nonlinearComplianceMatrixSensorValuesTime.pickle',  'rb') ) # loading sensor values
