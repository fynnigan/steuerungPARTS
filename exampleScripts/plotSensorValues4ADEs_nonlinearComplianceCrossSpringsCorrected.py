...
#%% load sensor data
SensorValuesIdeal = pickle.load( open('output/nonlinearComplianceMatrixStaticCrossSprings/SensorValuesCrossSprings.pickle',  'rb') ) # loading sensor values
SensorValuesIdealImport = pickle.load( open('output/nonlinearComplianceMatrixStaticCrossSprings/SensorValuesTimeCrossSprings.pickle',  'rb') ) # loading sensor values
...
# SensorValuesIdealImport = pickle.load( open('output/nonlinearComplianceMatrixStaticCircularHinge/nonlinearComplianceMatrixSensorValuesTime.pickle',  'rb') ) # loading sensor values
...
SensorValues4ATCRBSD = pickle.load( open('output/nonlinearComplianceMatrixStaticCrossSprings/SensorValues.pickle',  'rb') ) # loading sensor values
SensorValues4ATCRBSDImport = pickle.load( open('output/nonlinearComplianceMatrixStaticCrossSprings/SensorValuesTime.pickle',  'rb') ) # loading sensor values
