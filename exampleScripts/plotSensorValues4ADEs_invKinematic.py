...
#%% load sensor data
SensorValuesIdeal = pickle.load( open('output/invKinematicThreePoints/SensorValuesIdeal.pickle',  'rb') ) # loading sensor values
SensorValuesIdealImport = pickle.load( open('output/invKinematicThreePoints/SensorValuesTimeIdeal.pickle',  'rb') ) # loading sensor values
# SensorValuesIdeal = pickle.load( open('output/nonlinearComplianceMatrixStaticCrossSprings/nonlinearComplianceMatrixSensorValues.pickle',  'rb') ) # loading sensor values
# SensorValuesIdealImport = pickle.load( open('output/nonlinearComplianceMatrixStaticCrossSprings/nonlinearComplianceMatrixSensorValuesTime.pickle',  'rb') ) # loading sensor values
...
SensorValues4ATCRBSD = pickle.load( open('output/invKinematicThreePoints/SensorValuesCrossSprings.pickle',  'rb') ) # loading sensor values
SensorValues4ATCRBSDImport = pickle.load( open('output/invKinematicThreePoints/SensorValuesTimeCrossSprings.pickle',  'rb') ) # loading sensor values
...
SensorValues4ATCMeasurement = pickle.load( open('output/invKinematicThreePoints/nonlinearComplianceMatrixSensorValues.pickle',  'rb') ) # loading sensor values
SensorValuesIdealImport = pickle.load( open('output/invKinematicThreePoints/nonlinearComplianceMatrixSensorValuesTime.pickle',  'rb') ) # loading sensor values
...
SensorValuesIdeal = AverageMeshPointsOverElementDefinition(SensorValuesIdeal,adeNodes,adeMoveList,elementDefinition=False)
...
vf.plotMesh(SensorValues4ATCIdealTime,lineStep,plotFirstIndex=True,figureName=figName,labelATC=True)

lineStep=0 #first value of line 0
vf.plotMesh(SensorValues4ATCIdealTime,lineStep,plotFirstIndex=False,figureName=figName,labelATC=True)

lineStep=len(adeMoveList.data)-1 #first value of line 1
