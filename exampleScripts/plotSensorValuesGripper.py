...
SensorValuesIdeal = pickle.load( open('output/nonlinearComplianceGripper/nonlinearComplianceMatrixSensorValues.pickle',  'rb') ) # loading sensor values
SensorValuesIdealImport = pickle.load( open('output/nonlinearComplianceGripper/nonlinearComplianceMatrixSensorValuesTime.pickle',  'rb') ) # loading sensor values
...
SensorValues4ATCRBSD = pickle.load( open('output/nonlinearComplianceGripper/SensorValuesCrossSprings.pickle',  'rb') ) # loading sensor values
SensorValues4ATCRBSDImport = pickle.load( open('output/nonlinearComplianceGripper/SensorValuesTimeCrossSprings.pickle',  'rb') ) # loading sensor values
...
SensorValues4ATCMeasurement = pickle.load( open('output/nonlinearComplianceGripper/nonlinearComplianceMatrixSensorValues.pickle',  'rb') ) # loading sensor values
SensorValuesIdealImport = pickle.load( open('output/nonlinearComplianceGripper/nonlinearComplianceMatrixSensorValuesTime.pickle',  'rb') ) # loading sensor values
# meshPointsVicon = {}
# with open('data//experiments//4ADEs#//uncorrected//MeshPointsVicon.txt') as f:
#     lines = f.readlines()
